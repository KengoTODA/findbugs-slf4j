...
public class WrongPlaceholderDetectorTest {
    ...
    public void testCountParameterWithoutArray() throws ClassNotFoundException {
        ...
        assertThat(detector.countParameter(stack, "(Ljava/lang/String;Ljava/lang/Object;)V", throwableHandler)).isEqualTo(1);
        assertThat(detector.countParameter(stack, "(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V", throwableHandler)).isEqualTo(2);
        assertThat(detector.countParameter(stack, "(Lorg/slf4j/Marker;Ljava/lang/String;Ljava/lang/Object;)V", throwableHandler)).isEqualTo(1);
        ...
        assertThat(detector.countParameter(stack, "(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V", throwableHandler)).isEqualTo(1);
        assertThat(detector.countParameter(stack, "(Lorg/slf4j/Marker;Ljava/lang/String;Ljava/lang/Object;)V", throwableHandler)).isEqualTo(0);
        assertThat(detector.countParameter(stack, "(Lorg/slf4j/Marker;Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V", throwableHandler)).isEqualTo(1);
    }
}
