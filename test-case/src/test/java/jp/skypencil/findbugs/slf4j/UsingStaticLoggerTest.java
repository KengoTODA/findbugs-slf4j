...
public class UsingStaticLoggerTest {
  ...
  public void test() {
    ...
    Multimap<String, String> longMessages = new XmlParser().expect(pkg.UsingStaticLogger.class, expected);
    assertThat(longMessages).containsEntry("SLF4J_LOGGER_SHOULD_BE_NON_STATIC",
